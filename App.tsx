        ...
        <div className="max-w-[1600px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3 cursor-pointer group" onClick={handleReset}>
            ...
            <div>
              ...
              <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mt-0.5 group-hover:text-blue-400 transition-colors">Scientific Synthesis Engine</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
             {status === AnalysisStatus.COMPLETE && files.length > 0 && (
                <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-800 border border-slate-700 animate-in fade-in slide-in-from-top-2">
                  {files.length > 1 ? <Layers size={14} className="text-blue-400" /> : <FileText size={14} className="text-blue-400" />}
        ...
        {status === AnalysisStatus.IDLE && (
          <div className="flex flex-col items-center justify-center min-h-[75vh] max-w-4xl mx-auto text-center space-y-12 animate-in fade-in duration-700">
             ...
             <div className="space-y-6 max-w-2xl mx-auto">
               <h2 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-200 via-indigo-200 to-slate-200 tracking-tight leading-tight">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left w-full mt-8">
                <div className="p-5 rounded-xl bg-slate-800/20 border border-slate-800/60 hover:border-blue-500/30 hover:bg-slate-800/40 transition-all duration-300 group">
              ...
              <div className="h-8 relative overflow-hidden">
                 {LOADING_STEPS.map((step, idx) => (
                    ...
                    >
                      ...
                      <span className="text-blue-200 font-medium">{step}</span>
                    </div>
                 ))}
              </div>
            </div>
